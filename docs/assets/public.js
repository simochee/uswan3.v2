...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('menu-item', '<div class="menu-item {open: isOpen}" onclick="{toggle}"> <div class="summary"> <div class="date"> <div class="wrapper"> <div class="day">14</div> <div class="week">Sun</div> </div> </div> <div class="menu"> <div class="menu-main breakfast"><span class="main-item" if="{data.breakfast.jap}">{data.breakfast.jap}</span><span class="main-item" if="{data.breakfast.wes}">{data.breakfast.wes}</span></div> <div class="menu-main lunch"><span class="main-item">{data.lunch.main}</span></div> <div class="menu-main dinner"><span class="main-a">{data.dinner.a}</span><span class="main-b">{data.dinner.b}</span></div> </div> </div> <div class="detail"> <h1>hello</h1> </div> </div>', 'menu-item .menu-item,[data-is="menu-item"] .menu-item{ overflow: hidden; position: relative; margin: 0 10px 30px; box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 3px 1px -2px rgba(0,0,0,0.2), 0 1px 5px 0 rgba(0,0,0,0.12); background: rgba(255,255,255,0.1); transition: background 0.5s ease; } menu-item .menu-item .summary,[data-is="menu-item"] .menu-item .summary{ display: flex; transition: transform 0.4s 0.2s ease; } menu-item .menu-item .summary .date,[data-is="menu-item"] .menu-item .summary .date{ position: relative; width: 80px; margin: 8px 0; border-right: 1px solid rgba(170,170,170,0.3); } menu-item .menu-item .summary .date .wrapper,[data-is="menu-item"] .menu-item .summary .date .wrapper{ position: absolute; top: 50%; left: 50%; width: 80px; height: 40px; margin: -20px -40px; color: rgba(0,0,0,0.75); text-align: center; } menu-item .menu-item .summary .date .wrapper .day,[data-is="menu-item"] .menu-item .summary .date .wrapper .day{ line-height: 28px; font-size: 15px; } menu-item .menu-item .summary .date .wrapper .week,[data-is="menu-item"] .menu-item .summary .date .wrapper .week{ line-height: 12px; font-size: 10px; } menu-item .menu-item .summary .date .menu-main,[data-is="menu-item"] .menu-item .summary .date .menu-main{ flex: 1; } menu-item .menu-item .detail,[data-is="menu-item"] .menu-item .detail{ position: absolute; top: 0; left: -100%; width: 100%; transition: left 0.4s 0.2s ease; } menu-item .menu-item.open,[data-is="menu-item"] .menu-item.open{ background: rgba(255,255,255,0.5); } menu-item .menu-item.open .summary,[data-is="menu-item"] .menu-item.open .summary{ transform: translateX(100%); } menu-item .menu-item.open .detail,[data-is="menu-item"] .menu-item.open .detail{ left: 0; }', '', function (opts) {
	    var _this = this;
