...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('navbar', '<nav class="navbar"> <ul class="navbar-nav"> <li class="nav-large"><a class="nav-large-wrapper" href="#/menu"> <div class="icon ion-coffee"></div> <div class="label">献立表</div></a></li> <li class="nav-item"><a class="nav-anchor" href="#/search"> <div class="icon ion-android-search"></div> <div class="label">検索</div></a></li> <li class="nav-item"><a class="nav-anchor" href="#/schedule"> <div class="icon ion-ios-calendar-outline"></div> <div class="label">時間割</div></a></li> <li class="nav-item"><a class="nav-anchor" href="#/info"> <div class="icon ion-ios-information"></div> <div class="label">おしらせ</div></a></li> <li class="nav-more"><a class="nav-anchor {open: isOpen}" href="#" onclick="{toggleMoreMenu}"> <div class="navicon ion-navicon"></div> <div class="closer ion-android-close"></div></a></li> </ul> </nav> <more-menu></more-menu>', 'navbar .navbar,[data-is="navbar"] .navbar{ position: fixed; bottom: 0; left: 0; width: 100%; height: 55px; padding: 0 60px 0 110px; box-sizing: border-box; background: #fff; z-index: 100; } navbar .navbar .navbar-nav,[data-is="navbar"] .navbar .navbar-nav{ display: flex; justify-content: stretch; } navbar .navbar .navbar-nav .nav-item,[data-is="navbar"] .navbar .navbar-nav .nav-item{ flex: 1; text-align: center; } navbar .navbar .navbar-nav .nav-item .nav-anchor,[data-is="navbar"] .navbar .navbar-nav .nav-item .nav-anchor{ display: block; padding: 5px 0; text-decoration: none; color: #222; } navbar .navbar .navbar-nav .nav-item .nav-anchor .icon,[data-is="navbar"] .navbar .navbar-nav .nav-item .nav-anchor .icon{ line-height: 30px; font-size: 25px; } navbar .navbar .navbar-nav .nav-item .nav-anchor .label,[data-is="navbar"] .navbar .navbar-nav .nav-item .nav-anchor .label{ line-height: 15px; font-size: 10px; } navbar .navbar .navbar-nav .nav-large,[data-is="navbar"] .navbar .navbar-nav .nav-large{ position: absolute; top: -55px; left: 0; width: 110px; height: 110px; background: #fff; border-radius: 100%; } navbar .navbar .navbar-nav .nav-large .nav-large-wrapper,[data-is="navbar"] .navbar .navbar-nav .nav-large .nav-large-wrapper{ position: relative; display: block; width: 96px; height: 96px; margin: 4px; border-radius: 100%; border: 3px solid #222; color: #222; } navbar .navbar .navbar-nav .nav-large .nav-large-wrapper .icon,[data-is="navbar"] .navbar .navbar-nav .nav-large .nav-large-wrapper .icon{ font-size: 40px; text-align: center; line-height: 80px; } navbar .navbar .navbar-nav .nav-large .nav-large-wrapper .label,[data-is="navbar"] .navbar .navbar-nav .nav-large .nav-large-wrapper .label{ position: absolute; bottom: 5px; left: 0; width: 100%; height: 35px; text-align: center; font-size: 12px; line-height: 35px; } navbar .navbar .navbar-nav .nav-more,[data-is="navbar"] .navbar .navbar-nav .nav-more{ position: absolute; top: 0; right: 0; width: 60px; height: 55px; font-size: 36px; } navbar .navbar .navbar-nav .nav-more .nav-anchor,[data-is="navbar"] .navbar .navbar-nav .nav-more .nav-anchor{ position: relative; display: block; color: #222; } navbar .navbar .navbar-nav .nav-more .nav-anchor > div,[data-is="navbar"] .navbar .navbar-nav .nav-more .nav-anchor > div{ position: absolute; width: 60px; height: 55px; text-align: center; line-height: 55px; transition: all 0.3s ease; } navbar .navbar .navbar-nav .nav-more .nav-anchor .navicon,[data-is="navbar"] .navbar .navbar-nav .nav-more .nav-anchor .navicon{ opacity: 1; transform: translateX(0); } navbar .navbar .navbar-nav .nav-more .nav-anchor .closer,[data-is="navbar"] .navbar .navbar-nav .nav-more .nav-anchor .closer{ opacity: 0; transform: translateX(12px); } navbar .navbar .navbar-nav .nav-more .nav-anchor.open .navicon,[data-is="navbar"] .navbar .navbar-nav .nav-more .nav-anchor.open .navicon{ opacity: 0; transform: translateX(-12px); } navbar .navbar .navbar-nav .nav-more .nav-anchor.open .closer,[data-is="navbar"] .navbar .navbar-nav .nav-more .nav-anchor.open .closer{ opacity: 1; transform: translateX(0); }', '', function (opts) {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('more-menu', '<div class="bottom-menu {open: isOpen}"> <ul class="bottom-nav"> <li class="nav-item"></li> </ul> </div> <div class="side-menu {open: isOpen}"> <header> <div class="brand">デジタル版 白鳥寮献立表</div> </header> <main> <div class="preferences"> <h3>設定</h3> <dl> <dt>最初に表示するページ</dt> <dd> <div class="select-full"> <div class="label">{firstValue || \'今月の献立\'}</div> <select class="input" onchange="{updateFirstView}"> <option value="#/menu">今日からの献立</option> <option value="">時間割</option> <option value="">おしらせ</option> </select> </div> </dd> <dt>デフォルトのクラス <div class="select"> <div class="label"></div> </div> </dt> </dl> </div> </main> </div>', 'more-menu .bottom-menu,[data-is="more-menu"] .bottom-menu{ position: fixed; left: 55px; bottom: 0; right: 0; height: 55px; background: #fff; z-index: 1; transition: bottom 0.3s ease; } more-menu .bottom-menu.open,[data-is="more-menu"] .bottom-menu.open{ bottom: 55px; } more-menu .side-menu,[data-is="more-menu"] .side-menu{ position: fixed; top: 0; right: -240px; bottom: 55px; width: 240px; background: #fff; transition: right 0.3s ease; } more-menu .side-menu.open,[data-is="more-menu"] .side-menu.open{ right: 0; } more-menu .side-menu header,[data-is="more-menu"] .side-menu header{ position: relative; width: 100%; height: 160px; background: #ad1514; } more-menu .side-menu header .brand,[data-is="more-menu"] .side-menu header .brand{ height: 120px; color: #fff; text-align: center; line-height: 120px; } more-menu .side-menu header .version,[data-is="more-menu"] .side-menu header .version{ position: absolute; top: 0; right: 0; margin: 5px 8px; color: rgba(255,255,255,0.4); font-size: 10px; } more-menu .side-menu main,[data-is="more-menu"] .side-menu main{ position: absolute; top: 120px; left: 0; bottom: 0; right: 0; overflow-y: auto; padding-bottom: 55px; background: #fff; } more-menu .side-menu main .menu-nav,[data-is="more-menu"] .side-menu main .menu-nav{ padding: 25px 0; } more-menu .side-menu main .menu-nav .nav-item .nav-anchor,[data-is="more-menu"] .side-menu main .menu-nav .nav-item .nav-anchor{ display: block; height: 50px; padding: 0 20px; font-size: 15px; line-height: 50px; color: #444a5a; text-decoration: none; } more-menu .side-menu main .preferences,[data-is="more-menu"] .side-menu main .preferences{ margin: 0 15px 0; } more-menu .side-menu main .preferences h3,[data-is="more-menu"] .side-menu main .preferences h3{ color: #444; font-size: 16px; font-weight: bold; } more-menu .side-menu main .preferences dl dt,[data-is="more-menu"] .side-menu main .preferences dl dt{ font-size: 14px; } more-menu .side-menu main .preferences dl dd .select-full,[data-is="more-menu"] .side-menu main .preferences dl dd .select-full{ position: relative; width: 100%; height: 35px; } more-menu .side-menu main .preferences dl dd .select-full .label,[data-is="more-menu"] .side-menu main .preferences dl dd .select-full .label{ position: absolute; width: 100%; height: 35px; background: #fff; box-sizing: border-box; border: 1px solid #ccc; border-radius: 5px; line-height: 35px; font-size: 12px; text-align: center; z-index: 1; pointer-events: none; } more-menu .side-menu main .preferences dl dd .select-full .input,[data-is="more-menu"] .side-menu main .preferences dl dd .select-full .input{ position: absolute; display: block; width: 100%; height: 35px; }', '', function (opts) {
	    var _this = this;
	    ...
	    obs.on('more-menu:toggle', function () {
	        _this.isOpen = !_this.isOpen;
	        _this.update();
	    });
	
	    obs.on('more-menu:open', function () {
	        _this.isOpen = true;
	        _this.update();
	    });
	
	    obs.on('more-menu:close', function () {
	        _this.isOpen = false;
	        _this.update();
	    });
	});
