...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('menu', '<div class="daily-menu"> <div class="header">今日の献立</div> <div class="main"> <input class="visibility-input" id="dailyMenuBreakfast" type="radio" name="dailyMenu" checked> <label class="menu-item" for="dailyMenuBreakfast"> <div class="label">朝</div> </label> <input class="visibility-input" id="dailyMenuLunch" type="radio" name="dailyMenu"> <label class="menu-item" for="dailyMenuLunch"> <div class="label">昼</div> </label> <input class="visibility-input" id="dailyMenuDinner" type="radio" name="dailyMenu"> <label class="menu-item" for="dailyMenuDinner"> <div class="label">夜</div> </label> </div> </div>', 'menu .daily-menu,[data-is="menu"] .daily-menu{ margin: 10px 5%; background: rgba(255,255,255,0.35); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 3px 1px -2px rgba(0,0,0,0.2), 0 1px 5px 0 rgba(0,0,0,0.12); } menu .daily-menu .header,[data-is="menu"] .daily-menu .header{ width: 100%; height: 40px; color: rgba(51,51,51,0.8); font-size: 14px; line-height: 40px; text-align: center; } menu .daily-menu .main .visibility-input,[data-is="menu"] .daily-menu .main .visibility-input{ display: none; } menu .daily-menu .main .visibility-input:checked + .menu-item,[data-is="menu"] .daily-menu .main .visibility-input:checked + .menu-item{ background: rgba(255,255,255,0.8); } menu .daily-menu .main .menu-item,[data-is="menu"] .daily-menu .main .menu-item{ display: block; padding: 8px 20px; transition: all 0.6s ease; } menu .daily-menu .main .menu-item .label,[data-is="menu"] .daily-menu .main .menu-item .label{ width: 20px; height: 20px; font-size: 11px; border: 1px solid #333; border-radius: 100%; text-align: center; line-height: 20px; }', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
