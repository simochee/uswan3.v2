...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('daily-menu', '<div class="daily-menu"> <div class="header">今日の献立</div> <div class="main"> <div class="menu-item {open: isOpen == \'breakfast\', dailyMenuInit: init == \'breakfast\'}" id="dailyMenu-breakfast" onclick="{open(\'breakfast\')}"> <div class="label">朝</div> <div class="menu-body"> <div class="menu-main"> <div class="main-breakfast"><span class="main-item" if="{today.breakfast.jap}">{today.breakfast.jap}</span><span class="main-item" if="{today.breakfast.wes}">{today.breakfast.wes}</span></div> </div> <div class="menu-side"> <ul> <li each="{item in today.breakfast.side}">{item}</li> </ul> </div> </div> </div> <div class="menu-item {open: isOpen == \'lunch\', dailyMenuInit: init == \'lunch\'}" id="dailyMenu-lunch" onclick="{open(\'lunch\')}"> <div class="label">昼</div> <div class="menu-body"> <div class="menu-main">{today.lunch.main}</div> <div class="menu-side"> <ul> <li each="{item in today.lunch.side}">{item}</li> </ul> </div> </div> </div> <div class="menu-item {open: isOpen == \'dinner\', dailyMenuInit: init == \'dinner\'}" id="dailyMenu-dinner" onclick="{open(\'dinner\')}"> <div class="label">夜</div> <div class="menu-body"> <div class="menu-main"> <div class="main-dinner"><span class="main-a">{today.dinner.a}</span><span class="main-b">{today.dinner.b}</span></div> </div> <div class="menu-side"> <ul> <li each="{item in today.dinner.side}">{item}</li> </ul> </div> </div> </div> </div> </div>', 'daily-menu .daily-menu,[data-is="daily-menu"] .daily-menu{ margin: 10px 5%; background: rgba(255,255,255,0.35); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 3px 1px -2px rgba(0,0,0,0.2), 0 1px 5px 0 rgba(0,0,0,0.12); } daily-menu .daily-menu .header,[data-is="daily-menu"] .daily-menu .header{ width: 100%; height: 40px; color: rgba(51,51,51,0.8); font-size: 14px; line-height: 40px; text-align: center; } daily-menu .daily-menu .main .menu-item,[data-is="daily-menu"] .daily-menu .main .menu-item{ display: flex; align-items: center; padding: 8px 55px 8px 20px; transition: all 0.6s ease; } daily-menu .daily-menu .main .menu-item .label,[data-is="daily-menu"] .daily-menu .main .menu-item .label{ width: 20px; height: 20px; margin-right: 15px; border: 1px solid #333; border-radius: 100%; font-size: 11px; text-align: center; line-height: 20px; } daily-menu .daily-menu .main .menu-item .menu-body,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body{ flex: 1; } daily-menu .daily-menu .main .menu-item .menu-body .menu-main,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main{ margin: 8px 0; text-align: center; font-size: 20px; line-height: 28px; } daily-menu .daily-menu .main .menu-item .menu-body .menu-main .main-breakfast span:nth-child(2)::before,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main .main-breakfast span:nth-child(2)::before{ content: \'/\'; } daily-menu .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span{ display: block; } daily-menu .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span:not(:first-child),[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span:not(:first-child){ margin-top: 8px; } daily-menu .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-a::before,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-a::before,daily-menu .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-b::before,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-b::before{ display: inline-block; width: 20px; height: 20px; margin-right: 0.4em; line-height: 20px; font-size: 16px; background: #333; color: #eee; transform: translateY(-2px); } daily-menu .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-a::before,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-a::before{ content: \'A\'; } daily-menu .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-b::before,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-main .main-dinner span.main-b::before{ content: \'B\'; } daily-menu .daily-menu .main .menu-item .menu-body .menu-side,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-side{ overflow: hidden; height: 0; transition: height 0.3s; } daily-menu .daily-menu .main .menu-item .menu-body .menu-side li,[data-is="daily-menu"] .daily-menu .main .menu-item .menu-body .menu-side li{ font-size: 16px; line-height: 30px; text-align: center; } daily-menu .daily-menu .main .menu-item.open,[data-is="daily-menu"] .daily-menu .main .menu-item.open{ background: rgba(255,255,255,0.8); } daily-menu .daily-menu .main .menu-item.open .menu-body .menu-side,[data-is="daily-menu"] .daily-menu .main .menu-item.open .menu-body .menu-side{ transition: height 0.4s 0.3s ease; }', '', function (opts) {
	    var _this = this;
	    ...
	    this.on('mount', function () {
	        ...
	        var len = _this.today[_this.init].side.length;
