...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('side-menu', '<div class="side-menu {open: isOpen}"> <header> <div class="brand">デジタル版 白鳥寮献立表</div> </header> <main> <div class="preferences"> <h3>設定</h3> <dl> <dt>最初に表示するページ</dt> <dd> <div class="select-full"> <div class="label">{firstValue || \'今月の献立\'}</div> <select class="input" onchange="{updateFirstView}"> <option value="#/menu">今日からの献立</option> <option value="">時間割</option> <option value="">おしらせ</option> </select> </div> </dd> <dt>デフォルトのクラス <div class="select"> <div class="label"></div> </div> </dt> </dl> </div> </main> </div>', 'side-menu .side-menu,[data-is="side-menu"] .side-menu{ position: fixed; top: 0; right: -240px; bottom: 55px; width: 240px; background: #fff; transition: right 0.3s ease; } side-menu .side-menu.open,[data-is="side-menu"] .side-menu.open{ right: 0; } side-menu .side-menu header,[data-is="side-menu"] .side-menu header{ position: relative; width: 100%; height: 160px; background: #ad1514; } side-menu .side-menu header .brand,[data-is="side-menu"] .side-menu header .brand{ height: 120px; color: #fff; text-align: center; line-height: 120px; } side-menu .side-menu header .version,[data-is="side-menu"] .side-menu header .version{ position: absolute; top: 0; right: 0; margin: 5px 8px; color: rgba(255,255,255,0.4); font-size: 10px; } side-menu .side-menu main,[data-is="side-menu"] .side-menu main{ position: absolute; top: 120px; left: 0; bottom: 0; right: 0; overflow-y: auto; padding-bottom: 55px; background: #fff; } side-menu .side-menu main .menu-nav,[data-is="side-menu"] .side-menu main .menu-nav{ padding: 25px 0; } side-menu .side-menu main .menu-nav .nav-item .nav-anchor,[data-is="side-menu"] .side-menu main .menu-nav .nav-item .nav-anchor{ display: block; height: 50px; padding: 0 20px; font-size: 15px; line-height: 50px; color: #444a5a; text-decoration: none; } side-menu .side-menu main .preferences,[data-is="side-menu"] .side-menu main .preferences{ margin: 0 15px 0; } side-menu .side-menu main .preferences h3,[data-is="side-menu"] .side-menu main .preferences h3{ color: #444; font-size: 16px; font-weight: bold; } side-menu .side-menu main .preferences dl dt,[data-is="side-menu"] .side-menu main .preferences dl dt{ font-size: 14px; } side-menu .side-menu main .preferences dl dd .select-full,[data-is="side-menu"] .side-menu main .preferences dl dd .select-full{ position: relative; width: 100%; height: 35px; } side-menu .side-menu main .preferences dl dd .select-full .label,[data-is="side-menu"] .side-menu main .preferences dl dd .select-full .label{ position: absolute; width: 100%; height: 35px; background: #fff; box-sizing: border-box; border: 1px solid #ccc; border-radius: 5px; line-height: 35px; font-size: 12px; text-align: center; z-index: 1; pointer-events: none; } side-menu .side-menu main .preferences dl dd .select-full .input,[data-is="side-menu"] .side-menu main .preferences dl dd .select-full .input{ position: absolute; display: block; width: 100%; height: 35px; }', '', function (opts) {
	    var _this = this;
