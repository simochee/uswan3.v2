...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('navbar', '<nav class="navbar"> <ul class="navbar-nav {open: isOpen}"> <li class="nav-item"><a class="nav-anchor" href="#/search"> <div class="icon ion-android-search"></div> <div class="label">検索</div></a></li> <li class="nav-item"><a class="nav-anchor" href="#/schedule"> <div class="icon ion-ios-calendar-outline"></div> <div class="label">時間割</div></a></li> <li class="nav-item"><a class="nav-anchor" href="#/info"> <div class="icon ion-ios-information-outline"></div> <div class="label">おしらせ</div></a></li> <li class="nav-item"><a class="nav-anchor" href="#" target="_blank"> <div class="icon ion-social-twitter-outline"></div> <div class="label">Twitter</div></a></li> </ul> <div class="nav-large"><a class="nav-large-wrapper" href="#/menu"> <div class="icon ion-coffee"></div> <div class="label">献立表</div></a></div> <div class="nav-more"><a class="nav-anchor {open: isOpen}" href="#" onclick="{toggleMoreMenu}"> <div class="navicon ion-navicon"></div> <div class="closer ion-android-close"></div></a></div> </nav> <more-menu></more-menu>', 'navbar .navbar,[data-is="navbar"] .navbar{ position: fixed; bottom: 0; left: 0; width: 100%; height: 55px; padding: 0 60px 0 110px; box-sizing: border-box; z-index: 100; } navbar .navbar .navbar-nav,[data-is="navbar"] .navbar .navbar-nav{ height: 110px; margin: 0 -60px 0 -55px; padding: 0 60px 0 55px; background: #fff; transition: transform 0.3s ease; } navbar .navbar .navbar-nav.open,[data-is="navbar"] .navbar .navbar-nav.open{ transform: translateY(-55px); } navbar .navbar .navbar-nav .nav-item,[data-is="navbar"] .navbar .navbar-nav .nav-item{ float: left; width: 33.333%; text-align: center; } navbar .navbar .navbar-nav .nav-item .nav-anchor,[data-is="navbar"] .navbar .navbar-nav .nav-item .nav-anchor{ display: block; padding: 5px 0; text-decoration: none; color: #222; } navbar .navbar .navbar-nav .nav-item .nav-anchor .icon,[data-is="navbar"] .navbar .navbar-nav .nav-item .nav-anchor .icon{ line-height: 30px; font-size: 25px; } navbar .navbar .navbar-nav .nav-item .nav-anchor .label,[data-is="navbar"] .navbar .navbar-nav .nav-item .nav-anchor .label{ line-height: 15px; font-size: 10px; } navbar .navbar .nav-large,[data-is="navbar"] .navbar .nav-large{ position: absolute; top: -55px; left: 0; width: 110px; height: 110px; background: #fff; border-radius: 100%; border-bottom-left-radius: 0; } navbar .navbar .nav-large .nav-large-wrapper,[data-is="navbar"] .navbar .nav-large .nav-large-wrapper{ position: relative; display: block; width: 96px; height: 96px; margin: 4px; border-radius: 100%; border: 3px solid #222; color: #222; } navbar .navbar .nav-large .nav-large-wrapper .icon,[data-is="navbar"] .navbar .nav-large .nav-large-wrapper .icon{ font-size: 40px; text-align: center; line-height: 80px; } navbar .navbar .nav-large .nav-large-wrapper .label,[data-is="navbar"] .navbar .nav-large .nav-large-wrapper .label{ position: absolute; bottom: 5px; left: 0; width: 100%; height: 35px; text-align: center; font-size: 12px; line-height: 35px; } navbar .navbar .nav-more,[data-is="navbar"] .navbar .nav-more{ position: absolute; top: 0; right: 0; width: 60px; height: 55px; font-size: 36px; } navbar .navbar .nav-more .nav-anchor,[data-is="navbar"] .navbar .nav-more .nav-anchor{ position: relative; display: block; color: #222; } navbar .navbar .nav-more .nav-anchor > div,[data-is="navbar"] .navbar .nav-more .nav-anchor > div{ position: absolute; width: 60px; height: 55px; text-align: center; line-height: 55px; transition: all 0.3s ease; } navbar .navbar .nav-more .nav-anchor .navicon,[data-is="navbar"] .navbar .nav-more .nav-anchor .navicon{ opacity: 1; transform: translateY(0); } navbar .navbar .nav-more .nav-anchor .closer,[data-is="navbar"] .navbar .nav-more .nav-anchor .closer{ opacity: 0; transform: translateY(12px); } navbar .navbar .nav-more .nav-anchor.open .navicon,[data-is="navbar"] .navbar .nav-more .nav-anchor.open .navicon{ opacity: 0; transform: translateY(-12px); } navbar .navbar .nav-more .nav-anchor.open .closer,[data-is="navbar"] .navbar .nav-more .nav-anchor.open .closer{ opacity: 1; transform: translateY(0); }', '', function (opts) {
	    var _this = this;
