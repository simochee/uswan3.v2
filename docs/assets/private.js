...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('navbar', '<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header"> <header class="mdl-layout__header"> <div class="mdl-layout__header-row"><span class="mdl-layout-title">myAdmin</span> <div class="mdl-layout-spacer"></div> </div> </header> <div class="mdl-layout__drawer"><span class="mdl-layout-title">myAdmin</span> <nav class="mdl-navigation"><a class="mdl-navigation__link" href="http://uswan.simo.website" target="_brank">サイトを表示</a><a class="mdl-navigation__link" href="#/menu">献立</a><a class="mdl-navigation__link" href="#/twitter">Twitter Config</a></nav> </div> </div>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
